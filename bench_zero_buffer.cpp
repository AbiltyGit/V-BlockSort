...
void RunZeroBufferSuite(size_t N, int RUNS) {
    std::cout << "\n=========================================================================================\n";
    std::cout << " PURE IN-PLACE ZERO-BUFFER BENCHMARK: MaxStackBytes = 0 (N = " << N << ")\n";
    std::cout << " (0 Bytes Heap, 0 Bytes Stack Buffer - Measuring Pure In-Place Performance)\n";
    std::cout << "=========================================================================================\n\n";
    ...
    std::cout << std::left << std::setw(28) << "Distribution"
              << std::right << std::setw(20) << "V-Block (0-Buf Orig)"
              << std::setw(20) << "V-Block (0-Buf SAT)"
              << std::setw(15) << "Speedup"
    ...
    for (auto dist : distributions) {
        ...
        std::cout << std::left << std::setw(28) << DistName(dist)
                  << std::right << std::setw(17) << std::fixed << std::setprecision(2) << avg_orig << " ms"
...
int main() {
    RunZeroBufferSuite(100000, 3);
    RunZeroBufferSuite(1000000, 3);
    return 0;
}
